...
// 1. **Basic** flashcards, which have a front (_"Who was the first president of the United States?"_), 
...
// and is [a common device in educational applications]
...
// 3. The **partial text**. This is what we get if we remove the **cloze deletion** from 
// the **full text**: _"... was the first president of the United States._
...
// If you have any questions about this project or the material we have covered, please post them in the 
// community channels in slack so that your fellow developers can help you! If you're still having trouble, 
